...
params: 
  ...
  goog_post:  ""
  # days_label: !r c("Thurs", "Fri", "Sat", "Sun", "Mon", "Tues", "Wed", "foo", "foo2")
  # days_of_year_number_range: !r seq(25, 31, 1)
  # days_of_year_number_range: !r c(237, 238, 239, 251, 252, 253, 256, 257, 258)
output:
...
---
background-image: url(images/who_we_are_2022-09-15_18880.svg)
...
---
background-image: url(images/who_we_are_facetwrap_2022-09-15_13304.svg)
background-size: contain
<!-- generated from analysis_workshop_attendance/libcal_roster.Rmd -->
<!-- https://github.com/libjohn/workshop_attendance/blob/master/libcal_roster.Rmd -->
...
Literate coding  / Coding Notebooks
...
R Markdown & Jupyter notebooks are an example of coding notebooks.  Quarto is a new approach; key a look-out.
