...
# gs4_auth_configure()
pre_workshop <- 
  read_sheet("https://docs.google.com/spreadsheets/d/1tVOVlVVqjaGIN0JFJAGorGzEob3B3vF947H6zLa6jmQ/edit#gid=526532007")
# post_workshop <- 
...
---
background-image: url(images/who_we_are_20200925.svg)
...
response_rate <- nrow(pre_workshop) / 30
...
pre_workshop %>% 
  ...
  geom_line() +
  geom_point() +
  scale_y_continuous(minor_breaks = NULL, limits = c(0,3)) +
  # scale_y_continuous(breaks = scales::pretty_breaks()) +
  scale_x_continuous(minor_breaks = NULL, 
                     breaks = seq(263, 268, 1),
                     labels = c("Sat", "Sun", "Mon", "Tues", "Wed", "Thur")) +
  # ylim(0,3) +
  labs(title = "Response rate over time",
       subtitle = "n = 4 ; Response rate: 13%", y = "",
...
---
background-image: url(images/pre_post_survey2.svg)
background-size: contain

---
backgroud-image: url(images/pre_post_survey2_20200918.svg)
background-size: contain
