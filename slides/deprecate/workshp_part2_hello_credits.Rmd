...
.f3.near-white[  
quickStart: Part 2.  Viz, pivot, join, models
]  
...
2. **You watched the videos** .black-30[(part 2, et. al.)] and **have questions** 

3. We will start exercises and answer questions as the countdown reaches zero...
]  
.pull-right[
.f6.right[https://is.gd/9Y4GHC]  
...
---
background-image: url(images/who_we_are_part2.svg)
background-size: contain

---
background-image: url(images/who_we_are_facet_part2.svg)
background-size: contain

---
```{r response rate plot2, echo=FALSE, fig.height=7, fig.width=10, message=FALSE, warning=FALSE, dev="svg"}
response_rate <- nrow(pre_workshop) / 62
...
pre_workshop %>% 
  ...
  scale_x_continuous(minor_breaks = NULL, 
                     ...
                     labels = c("Wed", "Thu", "Fri", "Sat", "Sun", "Mon","Tue", "Today")) +
  ylim(0,7) +
  labs(title = "Response rate over time",
       subtitle = "n = 19 ; Resposne rate: 30%", y = "",
...
plot_workflow <- pre_workshop %>% 
  ...
  theme_minimal() +
  labs(title = "Satisfaction with current visualization workflow",
...
```{r alt_plot, include=FALSE, fig.height=7, fig.width=10, message=FALSE, warning=FALSE, dev="svg"}
plot_workflow +
  theme_ft_rc(grid = "Y")  +
  labs(title = "Satisfaction with current visualization workflow",
       subtitle = "self reported",
