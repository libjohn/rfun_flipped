...
params: 
  workshop_date: "Sept. 27"
  workshop_time: "2-4pm"
  registered: 70
  goog_sheet_pre_workshop: "https://docs.google.com/spreadsheets/d/1iSJmrFwpBSt-YSFBzZOkiAJbQOjJ9rswZXZnwqGreus/edit?resourcekey#gid=1609068335"
  days_label: !r c("Sun", "Mon", "Tue", "Wed", "Fri", "Sat", "Sun", "Mon")
  days_of_year_number_range: !r seq(263, 270, 1)
...
# gs4_auth_configure()
pre_workshop <- 
  read_sheet(params$goog_sheet_pre_workshop)
post_workshop <-
  read_sheet("https://docs.google.com/spreadsheets/d/1iSJmrFwpBSt-YSFBzZOkiAJbQOjJ9rswZXZnwqGreus/edit?resourcekey#gid=1609068335")
...
---
background-image: url(images/who_we_are2_20210927.svg)
...
---
exclude: false
background-image: url(images/who_we_are_facet_20210927.svg)
background-size: contain
<!-- generated from analysis_workshop_attendance/libcal_roster.Rmd -->
<!-- https://github.com/libjohn/workshop_attendance/blob/master/libcal_roster.Rmd -->
...
```
<!-- _background-image: url(images/bigpicture.svg) -->
