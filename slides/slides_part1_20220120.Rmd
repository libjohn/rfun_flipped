...
params: 
  registered: 80
  goog_sheet: "https://docs.google.com/spreadsheets/d/17evhukqNwb8a4TCx5vp6vlmSy3cYAjDh5jjppLbDkkM/edit#gid=1544437031"
  goog_post:  ""
  days_label: !r c("Fri", "Sat", "Sun", "Mon", "Tue", "Wed", "Thurs", "Fri")
  days_of_year_number_range: !r seq(14, 21, 1)
output:
...
.f3[
1. Did you already .b[complete] the pre-workshop .b[survey]?  (check your email)
2. .b[You watched the videos] and have questions  
