...
# gs4_auth_configure()
pre_workshop <- 
  read_sheet("https://docs.google.com/spreadsheets/d/1j6X24WXjZdFiI05mp_XjiJDea08Y2uvsqPljFoNrbWU/edit#gid=1555966674")
# post_workshop <- 
...
---
background-image: url(images/who_we_are_20200918.svg)
background-size: contain

---
background-image: url(images/who_we_are_facet_20200918.svg)
background-size: contain

---
```{r response rate plot, echo=FALSE, fig.height=7, fig.width=10, message=FALSE, warning=FALSE, dev="svg"}
response_rate <- nrow(pre_workshop) / 47
...
data_mgt_plot <- pre_workshop %>% 
  ...
  geom_bar() +
  geom_bar(data = . %>% filter(data_mgt == "Neutral"), aes(data_mgt), fill = "dark orange") + 
